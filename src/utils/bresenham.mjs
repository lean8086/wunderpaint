...
// export function plotQuadBezierSeg(x0, y0, x1, y1, x2, y2)
...
// export function plotQuadRationalBezierSeg(x0, y0, x1, y1, x2, y2, w)
...
// export function plotQuadRationalBezier(x0, y0, x1, y1, x2, y2, w)
...
// export function plotRotatedEllipseRect(x0, y0, x1, y1, zd)
...
// export function plotCubicBezierSeg(x0, y0, x1, y1, x2, y2, x3, y3)
...
// export function plotLineAA(x0, y0, x1, y1)
...
// export function plotCircleAA(xm, ym, r)
...
// export function plotEllipseRectAA(x0, y0, x1, y1)
...
// export function plotQuadBezierSegAA(x0, y0, x1, y1, x2, y2)
...
// export function plotQuadBezierAA(x0, y0, x1, y1, x2, y2)
...
// export function plotQuadRationalBezierSegAA(x0, y0, x1, y1, x2, y2, w)
...
// export function plotQuadRationalBezierAA(x0, y0, x1, y1, x2, y2, w)
...
// export function plotRotatedEllipseAA(x, y, a, b, angle)
// {                                   /* plot ellipse rotated by angle (radian) */
//   var xd = a*a, yd = b*b;
//   var s = Math.sin(angle), zd = (xd-yd)*s;               /* ellipse rotation */
//   xd = Math.sqrt(xd-zd*s), yd = Math.sqrt(yd+zd*s);       /* surrounding rect*/
...
// export function plotRotatedEllipseRectAA(x0, y0, x1, y1, zd)
// {                  /* rectangle enclosing the ellipse, integer rotation angle */
//   var xd = x1-x0, yd = y1-y0, w = xd*yd;
//   if (w != 0.0) w = (w-zd)/(w+w);                    /* squared weight of P1 */
//   assert(w <= 1.0 && w >= 0.0);                /* limit angle to |zd|<=xd*yd */
...
// export function plotCubicBezierSegAA(x0, y0, x1, y1, x2, y2, x3, y3)
...
// export function plotCubicBezierAA(x0, y0, x1, y1, x2, y2, x3, y3)
// {                                              /* plot any cubic Bezier curve */
//   var n = 0, i = 0;
//   var xc = x0+x1-x2-x3, xa = xc-4*(x1-x2);
//   var xb = x0-x1-x2+x3, xd = xb+4*(x1+x2);
...
// export function plotLineWidth(x0, y0, x1, y1, th)
...
// export function plotEllipseRectWidth(x0, y0, x1, y1, th)
...
// export function plotQuadRationalBezierWidthSeg(x0, y0, x1, y1, x2, y2, w, th)
...
// export function plotQuadRationalBezierWidth(x0, y0, x1, y1, x2, y2, w, th)
// {                    /* plot any anti-aliased quadratic rational Bezier curve */
//   var x = x0-2*x1+x2, y = y0-2*y1+y2;
//   var xx = x0-x1, yy = y0-y1, ww, t, q;
...
// export function plotRotatedEllipseWidth(x, y, a, b, angle, th)
// {                                   /* plot ellipse rotated by angle (radian) */
//   var xd = a*a, yd = b*b;
//   var s = Math.sin(angle), zd = (xd-yd)*s;               /* ellipse rotation */
//   xd = Math.sqrt(xd-zd*s), yd = Math.sqrt(yd+zd*s);       /* surrounding rect*/
...
// export function plotRotatedEllipseRectWidth(x0, y0, x1, y1, zd, th)
// {                  /* rectangle enclosing the ellipse, integer rotation angle */
//   var xd = x1-x0, yd = y1-y0, w = xd*yd;
//   if (w != 0.0) w = (w-zd)/(w+w);                    /* squared weight of P1 */
//   assert(w <= 1.0 && w >= 0.0);                /* limit angle to |zd|<=xd*yd */
...
// export function plotCubicBezierWidth(x0, y0, x1, y1, x2, y2, x3, y3, th)
// {                                              /* plot any cubic Bezier curve */
//   var n = 0, i = 0;
//   var xc = x0+x1-x2-x3, xa = xc-4*(x1-x2);
//   var xb = x0-x1-x2+x3, xd = xb+4*(x1+x2);
...
// export function plotCubicBezierSegWidth(x0,y0, x1,y1, x2,y2, x3,y3, th)
